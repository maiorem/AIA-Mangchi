...
<body>
	...
	<form method="post" action="map.jsp"  id="location">
	</form>
				...
				.addressSearch(
						...
						function(result, status) {
							...
							if (status === kakao.maps.services.Status.OK) {
								...
								var html='';
								html += '<input type="text" name="latitude" value="'+coords.Ga+'">'; //위도
								html += '<input type="text" name="longitude" value="'+coords.Ha+'">'; //경도
								$('#location').html(html);
