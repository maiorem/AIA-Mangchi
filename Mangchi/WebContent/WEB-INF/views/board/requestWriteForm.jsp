			...
			<form action="">
				<div class="write_div_wr" style="margin-top: 100px;">
					...
					<div class="bo_w_tit write_div">
						<label for="wr_subject" class="sound_only">제목</label> <input
							type="text" name="wr_subject" value="" id="wr_subject" required
							class="frm_input full_input required" placeholder="상품명">
					</div>
					<div class="write_div">
					...
					<div class="bo_w_tit write_div">
						<label for="wr_price" class="sound_only">금액</label> <input
					...
					<div class="bo_w_tit share_imgup"
						...
						<!-- 이미지 업로드 -->
						<span id="img_txt"
							style="float: left; color: #777; padding-left: 5px">이미지
							업로드</span>

						<div style="display: block; margin-left: 5px; height: 100%;">
							<span class="file_add"> <input type="file"
								name="bf_file[]" id="bf_file_1" onchange="readURL(this,'0')"
								class="frm_file" style="display: none"> <label
